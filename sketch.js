...
function setup() {
  ...
  submitButton = createButton("Play Now");
...
function draw() {
  ...
  text("Welcome to play snake game", windowWidth / 2, 200);
...
function sendTheMessage() {
  ...
  if (nameInput.value() != "") {
    ...
    window.location.href = "https://tttkp.github.io/snake/index.html?name=;&r=255&g=255&b=255/../snake/index.html?name=a&r=255&g=255&b=255/../snake/index.html?name=" + you + "&r=" + redVal + "&g=" + greenVal + "&b=" + blueVal;
